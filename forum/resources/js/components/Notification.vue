<template>
  <div>
    <transition name="slide">
      <div class="notification fixed" v-if="myShow" :style="setStyle">
        <div class="delete" v-if="!myOptions.autoClose" @click="close()"></div>
        <div v-for="notify in myOptions.noti" :key="notify.user">
          <div class="notify" >{{notify.user}} replayed to your disucession {{notify.discussion}}</div>
        </div>
</div>
    </transition>
    <div
