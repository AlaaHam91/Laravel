<template>
  <div v-if="discussion">
    ...
    <div class="body mt-4">
      ...
      <div>
        <yimo-vue-editor v-model="replay"></yimo-vue-editor>
        <button
...
export default {
  ...
  computed: {
    // ...mapGetters("forum",["discussion"]) the first parameter to the name space and the computed name will be as the second paramter
    ...mapGetters({
  ...
  methods:{
    storeReply(){
      this.$store.dispatch("forum/storeReplay",{
        "content":this.replay,
