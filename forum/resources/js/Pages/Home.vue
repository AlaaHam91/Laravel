    ...
    <div class="w-1/5 bg-gray-300 text-center p-6">
      ...
      <modal name="storeDiscussionModal" height="630">
        ...
        <form @submit.prevent="storeDiscussion">
          ...
          <button
            class="bg-red-400 text-white py-2 px-4 rounded-full uppercase text-sm"
            type="submit"
          >
            new discussion
          </button>
...
export default {
  ...
  methods: {
    ...
    storeDiscussion() {
      ...
      this.$store.dispatch("forum/fetchDiscussions");//to show the update after add Disscussion
